...
static SERVICE_STATUS_HANDLE srvcStatusHandle = NULL;
static SERVICE_STATUS srvcStatus;
static char srvcName[64] = DEF_SERVICE_NAME;
static char srvcVersion[32] = DEF_SERVICE_VERSION;
static char srvcMoudleFileName[MAX_PATH] = {0};
static bool isNSrvRun = false;
static HANDLE srvcStopEvent = NULL;
static APP_START_CB m_pStart = NULL;
static APP_STOP_CB m_pStop = NULL;
