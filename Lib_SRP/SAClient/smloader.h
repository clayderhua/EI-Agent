...
typedef int (SAMGRLOADER_API *UNSUBSCRIBECBFN)(char const * topic);
...
typedef void (SAMGRLOADER_API *SAMANAGER_SETUNSUBSCRIBECB)(UNSUBSCRIBECBFN func);
...
typedef struct SAMANAGER_INTERFACE
{
	...
	LOGHANDLE							logHandle;
	SAMANAGER_SETUNSUBSCRIBECB			SAManager_SetUnsubscribeCB_API;
}SAManager_Interface;
