...
#define STATUS_USR_LOGOUT			"User Logout"
...
#define STATUSCODE_USR_LOGOUT		603
...
typedef void (*post_report_data_cb)(void);
 ...
 *  Input : void* pHandle
 *			char *pInQuery, if *pInQuery = NULL, then stop all upload message.
 *  Output: None
 *  Return:  0 : Success 
 *          -1 : Fail 
 * ***************************************************************************************/
 ...
 *  Input : void* pHandle
 *			on_trigger - a callback function in the following form:
...
/* **************************************************************************************
 *  Function Name: HandlerKernelEx_SetPostReportDataCB
 *  Description: Set the callback function after report data, to clear local cache in plugin
 *  Input : void* pHandle
 *			post_report_data_cb cb - callback function that will call after data report
 *  Output: None
 *  Return:  0 : Success 
 *          -1 : Fail
 * ***************************************************************************************/
