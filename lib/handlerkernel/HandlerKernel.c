...
/* **************************************************************************************
*  Function Name: HandlerKernel_Start
...
*          -1 : Fail Init Handler
* ***************************************************************************************/
int HANDLERKERNEL_API HandlerKernel_Start()
{
	if (g_pHandlerKernel == NULL)
		return handler_fail;

	return HandlerKernelEx_Start(g_pHandlerKernel);
}

/* **************************************************************************************
*  Function Name: HandlerKernel_Stop
...
*          -1 : Fail
* ***************************************************************************************/
int HANDLERKERNEL_API HandlerKernel_Stop()
{
	if (g_pHandlerKernel == NULL)
		return handler_fail;

	return HandlerKernelEx_Stop(g_pHandlerKernel);
}
...
/* **************************************************************************************
 *  Function Name: HandlerKernel_SetPostReportDataCB
 *  Description: Set the callback function after report data, to clear local cache in plugin
 *  Input : post_report_data_cb cb - callback function that will call after data report
 *  Output: None
 *  Return:  0 : Success 
 *          -1 : Fail
 * ***************************************************************************************/
int HANDLERKERNEL_API HandlerKernel_SetPostReportDataCB(post_report_data_cb cb)
{
	return HandlerKernelEx_SetPostReportDataCB(g_pHandlerKernel, cb);
}